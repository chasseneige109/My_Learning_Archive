...
RMS Prop 실행: k - 1 번째 2nd moment(m_k-1) 와 back propagation으로 계산한 이번 gradient를 학습전에 미리 정해놓은 비율 (Beta 1, 약 0.9)로 지수이동평균(EMA)하여 이번 스텝의 1st moment(m_k)를 구하고, 이번 1st moment를 저장.
